...
rhos=(2 0.7 0.05 0.2 0 -0.7 -0.2 -0.05 -2)
...
#SBATCH -J rho_{rho}_rhoeps_{rho_eps}_$SLURM_JOB_ID
#SBATCH -o logs/rho_{rho}_rhoeps_{rho_eps}_$SLURM_JOB_ID.out
#SBATCH -e logs/rho_{rho}_rhoeps_{rho_eps}_$SLURM_JOB_ID.err
...
srun Rscript simulation_study_nig.R {rho} {rho_eps} $n_obs $n_rep
EOM
